...
var style_CabezasdecaprinosMAGyP_8 = function(feature, resolution){
    ...
    if (value >= 15.000000 && value <= 500.000000) {
            style = [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(0,0,0,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 1}),fill: new ol.style.Fill({color: 'rgba(231,243,255,1.0)'}),
